...
export default function CustomerData({ params }) {
  ...
  return (
    <>
      <div className="h-full w-full flex flex-col items-center overflow-hidden">
        ...
        {!isLoading && (
          <div className="mt-3 px-2 flex w-full flex-col md:flex-row dark:text-white">
            ...
            <div className="flex flex-row w-full mt-3 md:w-2/3 md:mt-0">
